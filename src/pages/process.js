...
export default function Process() {
  return (
    <Layout headTitle="Process" headerText="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Porta nibh venenatis cras sed felis. Proin fermentum leo vel orci porta non pulvinar. Luctus venenatis lectus magna fringilla urna porttitor. Placerat vestibulum lectus mauris ultrices eros in cursus. Commodo sed egestas egestas fringilla phasellus. Tempus imperdiet nulla malesuada pellentesque elit eget gravida cum. Et sollicitudin ac orci phasellus egestas tellus. ">
      ...
      <ProcessStep title="Rencontre, découverte et détermination de vos objectifs" noLine>
        Il est primordial à se connaître. L’élaboration d’une stratégie patrimoniale adaptée et personnalisée ne sera possible qu’après découverte de l’ensemble de votre situation économique, juridique, fiscale et successorale ainsi que de vos objectifs patrimoniaux.
      <br /><br /> Objectif : connaître votre situation, définir et hiérarchiser vos objectifs, lister et intégrer vos contraintes.
      </ProcessStep>
    </Layout>
