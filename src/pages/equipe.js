...
export default function Home() {
  return (
    ...
    thinTitleSection="Sarah Bouchité" 
    verySmallTitle="Associée fondatrice, Présidente"
    children="Titulaire du Master II ingénierie du patrimoine de Toulouse et d’une formation gestion de patrimoine professionnel, 
